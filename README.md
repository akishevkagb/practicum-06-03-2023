...
Помогают командам разработчиков работать быстрее и эффективнее.

3. Установка git на ваш ПК (в зависимости от системы)

Переходим на сатрницу загрузки https://git-scm.com/downloads и выбираем ннужную версию.

4. Установка VSCode на ваш ПК

Переходим на страницу загрузки https://code.visualstudio.com/Download и выбираем нужную версию

5. Что такое репозиторий и инструкция по созданию локальных репозиториев.

Репозиторий — место, где хранятся и поддерживаются какие-либо данные. Для создания локально репозитория Git необходимо открыть целевую папку и ввести команду *git init*
